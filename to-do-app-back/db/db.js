...
const devConfig = `mysql://${DB_USER}:${DB_PASSWORD}@${DB_HOST}/${DB_NAME}`;
...
// User.belongsToMany(Product, {through: 'favourites', foreignKey: 'UserId'});
// Product.belongsToMany(User, {through: 'favourites', foreignKey: 'ProductId'})
